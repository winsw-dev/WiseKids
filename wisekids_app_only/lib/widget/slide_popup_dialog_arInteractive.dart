                  ...
                  children: <Widget>[
                    Material(
                      ...
                      child: AnimatedOpacity(
                        ...
                        child: Container(
                          margin: EdgeInsets.only(bottom: contentHeight * (20 / 712)),
                          height: deviceHeight>500? contentHeight * (69 / 712):contentHeight * (75 / 712),
                          child: FittedBox(
                            fit: BoxFit.contain,
                            child: Text(
                              'Excellence !',
                    ...
                    Material(
                      ...
                      child: AnimatedOpacity(
                        ...
                        child: Container(
                          height: deviceHeight>500? contentHeight * (41 / 712):contentHeight * (47 / 712),
                          child: FittedBox(
                            fit: BoxFit.contain,
                            child: Text(
